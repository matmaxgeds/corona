...
Uganda {data-icon="fa-signal"}
===================================== 


Sierra Leone {data-icon="fa-signal"}  {.tabset .tabset-pills}
===================================== 
...
```{r, child = "report_child2.Rmd", echo = FALSE}
